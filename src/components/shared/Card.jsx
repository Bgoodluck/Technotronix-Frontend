...
//       {children}
//       {showDescription && (
//         <p className={`absolute top-0 left-0 right-0 bg-${descriptionColor}-200 text-white bg-orange-500 py-2 px-4 opacity-100 transition-opacity duration-300 `}>{description}</p>
//       )}
//     </div>
//   );
// }
